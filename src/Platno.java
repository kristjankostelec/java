...
public class Platno extends JPanel implements MouseMotionListener, MouseListener, KeyListener{
	...
	protected Color barvaVseh = Color.cyan;
	protected Color barvaIzbrane = Color.ORANGE;
	protected Color barvaOznacenih = Color.BLUE;
	protected Color barvaPovezav = Color.MAGENTA;
